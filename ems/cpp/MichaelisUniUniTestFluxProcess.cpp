...
LIBECS_DM_CLASS( MichaelisUniUniTestFluxProcess, ContinuousProcess )
{

 public:

    LIBECS_DM_OBJECT( MichaelisUniUniTestFluxProcess, Process )
    {
    ...
    MichaelisUniUniTestFluxProcess()
        :
        KmS( 1.0 ),
        KmP( 1.0 ),
        KcF( 0.0 ),
...
LIBECS_DM_INIT( MichaelisUniUniTestFluxProcess, Process );
